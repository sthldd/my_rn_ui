    ...
    const renderItem = (item:string,index:number) =>{
        return(
            <TouchableOpacity key={index} style={[{
                ...
                backgroundColor:index === Props.defaultIndex ?Props.selectBackgroundColor: 'white',
                borderColor:index === Props.disabledIndex ? 'rgba(16, 142, 233,.5)' :''
            },
            ...
            >
                <Text style={{
                    color:index === Props.defaultIndex ? Props.selectTextColor : 'rgb(16, 142, 233)',
